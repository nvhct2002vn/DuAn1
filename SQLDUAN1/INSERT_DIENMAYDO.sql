...
VALUES  ('HD001','NV001','KH01','2021-01-01',N'Chưa thanh toán', N'Tiền mặt',N'BÁN  TRỰC TIẾP',100,7200000,N'NOT'),
		...
		('HD003','NV003','KH03','2020-03-03',N'Đã thanh toán', N'Tiền mặt',N'BÁN  TRỰC TIẾP',100,7500000,N'NOT'),
		('HD004','NV004','KH04','2021-04-04',N'Chờ thanh toán', N'Chuyển khoản',N'BÁN  TRỰC TIẾP',100,4750000,N'NOT'),
		('HD005','NV005','KH05','2020-05-05',N'Chờ thanh toán', N'Tiền mặt',N'BÁN  TRỰC TIẾP',100,8400000,N'NOT'),
		('HD006','NV006','KH06','2020-06-06',N'Chưa thanh toán', N'Thẻ',N'BÁN  TRỰC TIẾP',100,4550000,N'NOT'),
		('HD007','NV001','KH07','2021-07-07',N'Đã thanh toán', N'Chuyển khoản',N'BÁN  TRỰC TIẾP',100,2520000,N'NOT'),
		('HD008','NV002','KH08','2019-08-08',N'Đã thanh toán', N'Thẻ',N'BÁN  TRỰC TIẾP',100,2500000,N'NOT'),
		('HD009','NV003','KH09','2019-09-09',N'Chưa thanh toán', N'Chuyển khoản',N'BÁN  TRỰC TIẾP',100,750000,N'NOT')
