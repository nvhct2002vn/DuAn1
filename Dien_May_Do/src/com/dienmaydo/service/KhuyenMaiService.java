...
String INSERT_SQL = "insert into dbo.KHUYENMAI(MAKM, TENCT,HINHTHUC,BATDAU,KETTHUC,GIAMGIA,TRANGTHAI,MOTA) VALUES(?,?,?,?,?,?,?,?)"
    ...
    String DELETE_SQL = "BEGIN TRY\n"
            ...
            + "	ROLLBACK TRAN\n"
            + "END CATCH";
    String SELECT_ALL_SQL = "select dbo.KHUYENMAI.MAKM , TENCT,HINHTHUC,GIAMGIA ,dbo.DANHMUC.TENDM, dbo.SANPHAM.TENSP,dbo.SANPHAMCHITIET.TENSPCT,BATDAU,KETTHUC,KHUYENMAI.TRANGTHAI,KHUYENMAI.MOTA\n"
            ...
            + "								join dbo.SANPHAMCHITIET on dbo.SANPHAM.MASP=dbo.SANPHAMCHITIET.MASP";
    String SELECT_BY_ID_SQL = "select dbo.KHUYENMAI.MAKM , TENCT,HINHTHUC,GIAMGIA ,dbo.DANHMUC.TENDM, dbo.SANPHAM.TENSP,dbo.SANPHAMCHITIET.TENSPCT,BATDAU,KETTHUC,KHUYENMAI.TRANGTHAI,KHUYENMAI.MOTA\n"
            + "            from dbo.KHUYENMAI join dbo.DANHMUC_KHUYENMAI on dbo.KHUYENMAI.MAKM = dbo.DANHMUC_KHUYENMAI.MAKM\n"
            + "								join dbo.DANHMUC on dbo.DANHMUC_KHUYENMAI.MADANHMUC = dbo.DANHMUC.MADANHMUC\n"
            + "								join dbo.SANPHAM on dbo.DANHMUC.MADANHMUC=dbo.SANPHAM.MADANHMUC\n"
            + "								join dbo.SANPHAMCHITIET on dbo.SANPHAM.MASP=dbo.SANPHAMCHITIET.MASP"
